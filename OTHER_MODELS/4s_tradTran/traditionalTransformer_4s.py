...
plt.savefig("/uac/y19/khto9/ai/report/4sTransformerAUROC.png")
...
plt.legend(loc="lower right")
plt.savefig("/uac/y19/khto9/ai/report/4sTransformerAUPRC.png")
...
model.save('/uac/y19/khto9/ai/report/TransformerAUPRC_4s')