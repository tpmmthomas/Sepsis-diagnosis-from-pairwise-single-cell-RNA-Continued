...
plt.savefig("/uac/y19/khto9/ai/report/3sTransformerAUROC.png")
...
plt.legend(loc="lower right")
plt.savefig("/uac/y19/khto9/ai/report/3sTransformerAUPRC.png")
...
model.save('/uac/y19/khto9/ai/report/saved_model/TransformerAUPRC_3s')