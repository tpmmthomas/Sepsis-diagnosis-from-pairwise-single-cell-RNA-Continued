...
plt.title('AUROC curve for traditional Transformer')
plt.legend(loc="lower right")
plt.savefig("/uac/y19/khto9/ai/report/TransformerAUROC.png")
...
plt.title('AUPRC curve for traditional Transformer')
plt.legend(loc="lower right")
plt.savefig("/uac/y19/khto9/ai/report/TransformerAUPRC.png")
...
model.save('/uac/y19/khto9/ai/report/saved_model/TradTransformer_NOsparse')
