...
xtrain = r"/uac/y19/khto9/ai/CNN/training_sample_4s.csv.gz"
ytrain = r"/uac/y19/khto9/ai/CNN/training_label_4s.csv.gz"
xtest = r"/uac/y19/khto9/ai/CNN/testing_sample2_4s.csv.gz"
ytest = r"/uac/y19/khto9/ai/CNN/testing_label_4s.csv.gz"
...
plt.savefig("/uac/y19/khto9/ai/report/4sAUROCParallelCnnTrTransformer.png")
...
plt.legend(loc="lower right")
plt.savefig("/uac/y19/khto9/ai/report/4sAUPRCParallelCnnTrTransformer.png")
...
model.save_weights('./checkpoints_para_4s/my_checkpoint')